...
def process_snapshot(snapshot, index):
    try:
        ...
        filename = f"renminwang_agreement_{date_str}.txt"
...
# 1️⃣ 设置目标协议页面 URL
url = "https://sso.people.com.cn/resource/html/agreement.html"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = "./test/"
save_folder = os.path.join(desktop_path, "renminwang_User_Agreements")
