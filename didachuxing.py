...
def process_snapshot(snapshot, index):
    try:
        ...
        page.find_and_click_div_by_text(driver, " 注册协议 ")
        ...
        filename = f"didachuxing_agreement_{date_str}.txt"
...
# 1️⃣ 设置目标协议页面 URL
url = "https://web.didachuxing.com/web-public-lawrules"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = "./test/"
save_folder = os.path.join(desktop_path, "didachuxing_User_Agreements")
