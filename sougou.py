...
def process_snapshot(snapshot, index):
    try:
        ...
        filename = f"sougou_agreement_{date_str}.txt"
...
# 1️⃣ 设置目标协议页面 URL
url = "https://account.sogou.com/static/agreement.html"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = "./test/"
save_folder = os.path.join(desktop_path, "sougou_User_Agreements")
