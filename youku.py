...
def process_snapshot(snapshot, index):
    try:
        ...
        filename = f"youku_agreement_{date_str}.txt"
...
# 1️⃣ 设置目标协议页面 URL
url = "https://terms.alicdn.com/legal-agreement/terms/suit_bu1_unification/suit_bu1_unification202005142208_14749.html"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = "./test/"
save_folder = os.path.join(desktop_path, "youku_User_Agreements")
