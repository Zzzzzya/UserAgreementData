...
# 1️⃣ 设置目标协议页面 URL
url = "https://terms.alicdn.com/legal-agreement/terms/TD/TD201609301342_19559.html"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = os.path.join(os.path.expanduser("~"), "Desktop")
save_folder = os.path.join(desktop_path, "Taobao_User_Agreements")
...
for i, snapshot in enumerate(tqdm(snapshots, desc="抓取协议中（全量）")):
    ...
    try:
        ...
        filename = f"Taobao_agreement_{date_str}.txt"
