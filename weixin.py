...
def process_snapshot(snapshot, index):
    try:
        ...
        filename = f"weixin_agreement_{date_str}.txt"
...
# 1️⃣ 设置目标协议页面 URL
url = "https://weixin.qq.com/cgi-bin/readtemplate?lang=zh_CN&t=weixin_agreement&s=default"  # ← 你可以换成别的平台链接
user_agent = "Mozilla/5.0"


# 2️⃣ 在桌面新建保存文件夹
desktop_path = "./test/"
save_folder = os.path.join(desktop_path, "weixin_User_Agreements")
